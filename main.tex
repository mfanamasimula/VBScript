...
\end{figure}
	...
	\textbf{Events}\\
	\begin{figure}[h!]
	\includegraphics[width=\linewidth]{./events/EventModuleClassDiagram.jpg}
	...
	\textbf{Events Module}
\begin{figure}[h!]
	\includegraphics[width=\linewidth]{./events/UserSequenceDiagramEvents.jpg}
    \caption{User sequence diagram}
		 \label{fig:1}
\end{figure}
\includegraphics[width=\linewidth]{./events/adminSeq.jpg}
    \caption{User sequence diagram}
		 \label{fig:1}
\end{figure}
	...
	\textbf{Events}\\
\begin{figure}[h!]
	\includegraphics[width=\linewidth]{./events/User-list-all-events-on-the-system.jpg}
    \caption{User List all event}
		 \label{fig:UC1}
\end{figure}
\begin{figure}[h!]
	\includegraphics[width=\linewidth]{./events/administrator-user-add-new-event.jpg}
    \caption{Amnin Adds event}
		 \label{fig:UC3}
		 \begin{figure}[h!]
	\includegraphics[width=\linewidth]{./events/Administrator-user-edit-event-on-the-system.jpg}
    \caption{Amnin edits event}
		 \label{fig:UC3}
\end{figure}
	\textbf{Notification Module}\\
	\textbf{Users Module}\\\\
	...
	\textbf{Events}\\
	\begin{figure}[h!]
	\includegraphics[width=\linewidth]{./events/UserListsEvents.jpg}
    \caption{User List events}
		 \label{fig:1}
\end{figure}
\includegraphics[width=\linewidth]{./events/EventSelectionActivityDiagram.jpg}
    \caption{User selects event}
		 \label{fig:2}
\end{figure}
\includegraphics[width=\linewidth]{./events/AdminAddEventActivityDiagram.jpg}
    \caption{Admin user adds event}
		 \label{fig:3}
\end{figure}
\includegraphics[width=\linewidth]{./events/AdminChangeDeleteEventActivity.jpg}
    \caption{Admin can delete and change events}
		 \label{fig:4}
\end{figure}
	\textbf{Notification Module}\\
	\textbf{Users Module}\\
